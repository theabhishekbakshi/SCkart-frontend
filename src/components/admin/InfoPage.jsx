    ...
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
      <Card className="flex flex-col">
        ...
        <CardFooter className="flex-col gap-2 text-sm">
          <div className="leading-none text-muted-foreground">Showing total users for payment method</div>
        </CardFooter>
      </Card>
      ...
      <Card className="flex flex-col">
        ...
        <CardFooter className="flex-col gap-2 text-sm">
          <div className="leading-none text-muted-foreground">Displaying percentage distribution of payment methods</div>
        </CardFooter>
      </Card>
      ...
      <Card>
            ...
            <XAxis dataKey={"sold"} tickLine={false} tickMargin={10} axisLine={false} tickFormatter={(value)=> `${value}`}/>
              ...
              <Tooltip cursor={{fill: "#f0f0f0"}} content={({payload})=>{
                if(payload && payload.length){
                  ...
                  return(
                    <div style={{backgroundColor: "white", padding: '10px', border: "1px solid #ddd", fontSize: "12px"}}>
                      <strong>{name}</strong>
                      <br />
                      <span>Sold: {sold}</span>
                    </div>
        ...
        <CardFooter className="flex-col gap-2 text-sm">
          <div className="leading-none text-muted-foreground">Hover over a bar to see the product details</div>
        </CardFooter>
      </Card>
    </div>
  )
