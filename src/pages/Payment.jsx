...
const Payment = () => {
    ...
    const paymentHandler = async() =>{
        ...
        if(method==="online"){
            const stripePromise = loadStripe("pk_test_51TU0tFAVRxfa6etWybKaO036rJvwk0SDTxYLs3b8dCFXEgHnakcRafd5guQjNa6slZvM7QkBwYMTkgigFCIpf9ai00VzAJXzJ0")
            try {
                setLoading(true);
            ...
            <div className="space-y-8">
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        {
                            cart && cart.map((e, i)=>(
                                <div key={i} className="flex flex-col md:flex-row items-center justify-between bg-card p-4 rounded-lg border dark:border-gray-700">
